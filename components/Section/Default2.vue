...
<template>
    <div class="w-full py-16 px-12" style="background-color: #1A4480;">
        <div class="grid lg:grid-cols-12 items-stretch gap-10">
            <template v-if="props.section.type === 'about-right-image' || props.section.type === 'about-left-image'">
                <!-- Image column -->
                <div :class="[
                    props.section.type === 'about-left-image' && 'order-last',
                ...
                <!-- Content column -->
                <div class="lg:col-span-7 flex flex-col justify-center text-white text-center">
                    <!-- Title -->
                    <div v-if="props.section.title" class="text-3xl font-bold text-white font-merriweather mb-3" v-html="props.section.title" />
                    
                    <!-- Subtitle -->
                    <div v-if="props.section.subTitle" class="text-lg font-medium mb-2" v-html="props.section.subTitle" />
                    
                    <!-- Description -->
                    <div v-if="props.section.description" class="text-lg font-light mt-3 text-center" v-html="props.section.description" />
                    
                    <!-- Buttons -->
                    <div class="mt-5">
                        <div v-if="props.section.buttonOneActive || props.section.buttonTwoActive" class="flex flex-col md:flex-row justify-end gap-5">
