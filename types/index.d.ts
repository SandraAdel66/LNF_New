...
type PageSection <script lang="ts" setup>
...
type Conference = {
    id: number;<script lang="ts" setup>
const props = defineProps<{
    section: PageSection;
}>();
</script>
...
<template>
    <div class="container mx-auto py-16 px-12">
        <div class="grid lg:grid-cols-12 items-stretch gap-10"> <!-- Changed from items-center to items-stretch -->
            ...
            <div v-else-if="props.section.type === 'about-no-image'" class="lg:col-span-12"><script lang="ts" setup>
const props = defineProps<{
    section: PageSection;
}>();
</script>
